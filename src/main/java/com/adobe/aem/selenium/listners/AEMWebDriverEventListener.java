...
public class AEMWebDriverEventListener extends AbstractWebDriverEventListener {
	...
	public void beforeClickOn(WebElement element, WebDriver driver) {
		...
		logger.debug("Click on element " + element.getTagName() + " at location (" + element.getLocation().getX() + ","
	...
	public void beforeChangeValueOf(WebElement element, WebDriver driver, CharSequence[] keysToSend) {
		...
		logger.debug("Writing " + sb + " on element " + element.getTagName() + " at location ("
